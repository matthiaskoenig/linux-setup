...
git clone https://github.com/matthiaskoenig/dfba
git clone https://github.com/matthiaskoenig/modelmanager/
git clone https://github.com/matthiaskoenig/multiscale-galactose
git clone https://github.com/matthiaskoenig/caffeine
git clone https://github.com/matthiaskoenig/icg
git clone https://github.com/matthiaskoenig/acetaminophen

# cobraPy
git clone https://github.com/opencobra/cobrapy
